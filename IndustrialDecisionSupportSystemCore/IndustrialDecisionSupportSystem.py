from .Factory.ChemicalCompositionSystemFactory import ChemicalCompositionSystemFactory
from .Factory.IsothermalTransformationSystemFactory import IsothermalTransformationSystemFactory
...
class IndustrialDecisionSupportSystem:
    ...
    def _evaluate_chemical_composition(self):
        ...
        self._prepare_inference_system(ChemicalCompositionSystemFactory)
